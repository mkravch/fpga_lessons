proc getPresetInfo {} {
  return [dict create name {smart_zynq_ps} description {smart_zynq_ps}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {smart_zynq_ps} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO}  \
